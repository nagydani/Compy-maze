...
You can save a sequence of keys as a shortcut:
 ...
 1. Hold Shift and press a key — this names your shortcut.
    You hear a beep and see the key on screen with a blue
    background.
 2. While still holding Shift, press up to 7 keys — each
    one makes a click sound and appears on screen.
